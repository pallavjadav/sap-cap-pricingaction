...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("SchedulePriceRulesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheSchedulePriceRulesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheSchedulePriceRulesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheSchedulePriceRulesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheSchedulePriceRulesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheSchedulePriceRulesListGenerated.onTable().iPressRow(0);
            Then.onTheSchedulePriceRulesObjectPageGenerated.iSeeThisPage();
